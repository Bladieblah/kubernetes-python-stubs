...
class StorageV1Api:
    ...
    def read_csi_driver(self, name: str, *, pretty: typing.Optional[str] = ...) -> BaseHTTPResponse: ...
    ...
    def read_csi_node(self, name: str, *, pretty: typing.Optional[str] = ...) -> BaseHTTPResponse: ...
