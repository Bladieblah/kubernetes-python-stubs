...
class CoreV1Api:
    ...
    def read_namespace(self, name: str, *, pretty: typing.Optional[str] = ...) -> BaseHTTPResponse: ...
    ...
    def read_node(self, name: str, *, pretty: typing.Optional[str] = ...) -> BaseHTTPResponse: ...
    def replace_node(
        self,
        name: str,
        body: kubernetes.client.V1Node,
    ...
    def read_node_status(self, name: str, *, pretty: typing.Optional[str] = ...) -> BaseHTTPResponse: ...
